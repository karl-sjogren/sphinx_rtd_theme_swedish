  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'sphinx_rtd_theme_swedish/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'sphinx_rtd_theme_swedish/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'sphinx_rtd_theme_swedish/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["sphinx_rtd_theme_swedish/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['sphinx_rtd_theme_swedish/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
